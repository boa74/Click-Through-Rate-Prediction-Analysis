...
```{r column-formatting, eval=FALSE}
...
```{r distribution-plot, eval=FALSE, fig.width=10, fig.height=8}
library(ggplot2)
library(reshape2)
library(dplyr)
...
```{r random-forest-bagging, eval=FALSE}
...
```{r visualizations, eval=FALSE, fig.width=8, fig.height=6}
library(ggplot2)
...
```{r rmse-plot, echo=FALSE, fig.width=8, fig.height=6}
library(ggplot2)
...
```{r feature-importance, eval=FALSE, fig.width=8, fig.height=6}
